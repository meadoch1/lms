...
class ParticipantsControllerTest < ActionController::TestCase
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post :create, participant: { name: @participant.name, state: @participant.state }
    end
  ...
  test "should update participant" do
    put :update, id: @participant, participant: { name: @participant.name, state: @participant.state }
    assert_redirected_to participant_path(assigns(:participant))
  end
